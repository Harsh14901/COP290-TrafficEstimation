...
void ArgParser::set_argument(string field, string short_field, string default_value, bool compulsory,bool is_standalone)
{
    arguments.push_back(Argument(field, short_field, default_value, compulsory,is_standalone));
}
...
void ArgParser::set_argument(string field, string short_field, string default_value)
{
...
ArgParser::Argument *ArgParser::search_argument(string arg)
{
    ...
    for (auto i = 0u; i < arguments.size(); i++)
    {
        ...
        else if (is_short && ("-" + arguments[i].short_field) == arg && arguments[i].short_field != "")
        {
            return &arguments[i];
        }
    }
